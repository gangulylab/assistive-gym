...
class ObjectTestingEnv(AssistiveEnv):
    def __init__(self):
        super(ObjectTestingEnv, self).__init__(robot_type=None, task='object_testing', human_control=False, frame_skip=5, time_step=0.02)
